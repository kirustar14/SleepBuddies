        ...
        <div className="journal-container">
            <div className="tabs">
                <Stack spacing={2} direction="row" width="460px" margin="auto">
                    <Button variant="contained" className={activeTab === 'journal' ? 'active' : ''}
                            onClick={() => setActiveTab('journal')}>Journal Entry</Button>
                    <Button variant="contained" className={activeTab === 'chart' ? 'active' : ''}
                            onClick={() => setActiveTab('chart')}>Mood Chart</Button>
                    <Button variant="contained" className={activeTab === 'entries' ? 'active' : ''}
                            onClick={() => setActiveTab('entries')}>Past Entries</Button>
                </Stack>
            </div>
